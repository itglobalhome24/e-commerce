    ...
    return (
        <>
            <div onClick={() => handleClickCategory(title)} className='relative rounded-md overflow-hidden group h-64 w-3/4 mx-auto'>
                ...
                <p className='absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-6xl text-white font-roboto font-medium group-hover:bg-opacity-60 transition'>
                    {title}
                </p>
            </div>
        </>
