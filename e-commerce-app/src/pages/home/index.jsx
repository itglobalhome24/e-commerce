...
import homepage_img from "../../assets/images/homepage_building.jpeg"

const Home = () => {
    return (
        <div className='container mx-auto pt-10 pb-6 px-5 w-screen box-border'>
            <div className='grid grid-cols-1 sm:grid-cols-2 mb-14'>
                <img src={homepage_img} alt="homepage_promo_image" className='h-auto mb-5 sm:px-5 sm:col-span-1 rounded-xl' />
