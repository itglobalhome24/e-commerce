                ...
                <div className="border border-gray-200 p-4 rounded">
                    ...
                    <ul>
                        <li className="flex border-b border-gray-200">
                            <h5 className="text-gray-800 font-semibold w-20">Product</h5>
                        ...
                        {cartProducts.map((data, index) => (
                            <li key={index} className="flex border-b border-gray-200 py-4 mb-4">
                                <img src={data.images[0]} alt="" className='h-16 w-20' />
                                <h5 className="text-gray-800 font-medium w-1/2 pt-4">{data.title}</h5>
                                <p className="text-gray-800 font-medium w-24 text-center px-3 pt-4">₱ {data.price}</p>
                                <button onClick={() => handleClickRemove(data)} className='bg-primary text-white first-letter:first-line:w-20 h-1/3 rounded-md p-1 mt-3'>Remove</button>
                            </li>
                        ))}
                    </ul>
